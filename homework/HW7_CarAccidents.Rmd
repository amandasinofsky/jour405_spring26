...
There is one day in 2022 where there is an abnormally high value followed by a very low one shortly after. I would want to look at if anything significant occured that day that could explain why there were so many accidents one day and very few a little while later. There is also a significant dip in 2020 which I assumed could be traced back to covid. It seems that daily accidents reached their peak in 2021, so I wonder if this was also a result of people going back to normalcy after the pandemic. 
...
Monday through Thursday have lower averages of accidents than Fridays and the weekends. This could be because of drunk driving after going out on the weekend which could cause more accidents. 
...
I chose to look up October 29, 2021. On this day in Prince George's County, there was severe rain, winds and flooding, which likely contributed to the higher amount of accidents on that day. If I was reporting on the anomaly in the amount of accidents this day, I would include the weather situation to contextualize the unusual amount. 
...
The list with extreme day of week z-scores has more weekdays on it, while the extreme z-scores overall are mostly on the weekend. This further confirms that car accidents are more common on weekends, and therefore it makes sense that the extreme z-scores overall are from days on the weekend and the extreme day-of-week z-scores are on weekdays. 
...
May and October have the highest average accidents, and January and February have the lowest. It could be that weather conditions like rain combined with the leaves could create dangerous driving conditions. In the winter months, the snow could either fully prevent people from driving or cause them to be more cautious while doing so. 
...
They are all on the weekend or Fridays except for one day that is a Monday. 
...
Headline: Prince George's County sees increased car accidents on weekends

Lede: Accidents in Prince George's County are consistently more common on Fridays, Saturdays and Sundays than Monday through Thursday. 

I would want to talk to the police department about the accidents on the weekend and what it seems their most common cause is compared to during the week. I would want to know if this is because of increased drunk driving on the weekends, or if there is another reason there is an uptick in accidents on the weekends. 
