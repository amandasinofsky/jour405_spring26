...
Write a few sentences about the distribution of danceability scores in the Spotify dataset. Is it a normal distribution, or is it skewed in one direction? What does the mean and distribution tell us about the songs in the dataset? Draft a short story pitch from this data.

This seems to be a mostly normal distribution. It is skewed a little bit to the left, but is overall normal. This tells us that the majority of the songs have a danceability score close to the mean of 0.67. A story pitch for this data is that songs that were most popular in 2020 mostly had a similar danceability score, indicating preferences for popular music. 
