...
wh_paid |>
  ggplot () +
  geom_histogram(aes(x = SALARY), binwidth = 15000) +
...
The distribution is skewed to the right with most of the salaries clustered around 50,000 to 125,000. However, there is a good amount of salaries in the 200,000 range, but not as much as to the left of that. 
...
The data mostly follows the empirical rule, but not exactly. The slight deviation tells us that the distribution is not normal. However, it is more normal than I thought from originally observing it without the empirical rule. 
...
The normal approximation says that 16.9% of White House staffers are expected to earn above $150,000, while the actual data shows that 18.1% of White House staffers earn above $150,000. 
...
The normal approximation estimates that about 36.6% of White House staffers fall in this range, while the actual data says that 32.6% actually make between $80,000 and $120,000 a year. This shows that a large clump of workers make salaries within this range. 
...
The normal distribution predicts that many more staffers will make below 60k. It also predicts a significantly smaller amount of people in the 60k-90k range than there actually are. Something that could explain these differences is the specific roles that these staffers have in the White House because it is unlikely the amount of each position would line up perfectly with salaries on a normal distribution. 
...
Headline: Majority of White House staff earn middle-range salaries

Lede: Only about 18% of White House staffers earn over $150,000 a year, with about 32% earning between 80,000 and 120,000 a year. 

I would compare these probabilities to the past presidencies and the salaries of the staffers during those. I also would want to further analyze the distribution of specific positions in the White House and their corresponding salaries and if those line up with a normal distribution or not.
