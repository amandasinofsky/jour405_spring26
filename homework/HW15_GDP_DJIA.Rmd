...
gdp |> 
  ...
  geom_text(aes(x=GDP, y=DJIA, label=Quarter, title="GDP vs DJIA over time"))
```
...
There is a very strong correlation between the DJIA and GDP since the correlation coefficient is about 0.95. The scatterplot shows this with the strong trend line and the majority of the points very close to the line.  
