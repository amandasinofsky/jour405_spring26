...
There is a very weak positive correlation between fouls and the goal difference. The scatterplot confirms this with the very slightly tilted line throughout the scatterplot.
...
There is a very strong positive correlation between points and goal differences, indicating that more points is correlated with a bigger difference in goals. 
