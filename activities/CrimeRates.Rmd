...
The earliest years of the data, particularly the 1970s, had the highest violent crime rates. They have steadily trended down since then to where the lowest crime rates are 2010s. Property crime rates are following the same trend. If anything, I would have thought that crime has gone up over the years because of how prevalent it is in the media and the polarized state of the country. However, I can see from the data that crime has gone down overall.
