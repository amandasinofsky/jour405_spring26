...
The amount of calls overall goes up slightly in the summer months and goes down as the weather gets colder. I would draw a horizontal line at the low date in July, high date in October, and the low date in January. 
...
There aren't many unusual days in the lower half in the summer. It did not change my answer a lot from Task 3. 
...
October 4, 2022 had the most unusual amount of calls in one day.  
...
Looking at the days close together that have high z-scores and investigate what might have been happening with perhaps a bad batch of drugs on those days. You could also focus on October 4 and see what was going on that day to make it so irregular. 
